    ...
    class KDI_Shortcode {
        ...
        public static function init() {
            $shortcodes = array(
                ...
                'loop_template_part'    => __CLASS__ . '::loop_template_part',
                'tabs_link'             => __CLASS__ . '::tabs_link',

                'products_cat'          => __CLASS__ . '::filter_products_by_category',
                'products_newest'       => __CLASS__ . '::product_moi_nhat',
                'recents'               => __CLASS__ . '::recents',
                'products_popular'      => __CLASS__ . '::products_noibat',
                'products_best_sell'    => __CLASS__ . '::product_ban_chay',
            );
        ...
        public static function loop_template_part( $atts = array(), $content = null, $tag = null ) {
        ...
        public static function do_loop( $args = array() ) {
        ...
        // product filter
        public static function filter_products_by_category() {
            $args = array(
                'orderby'   => 'name',
                'order'     => 'ASC',
                'parent'    => '0',
        ...
        // product section
        public static function product_moi_nhat() {
            $args_filter = array(
        ...
        public static function product_danh_muc() {
            $args_filter = array(
                'post_type'         => array('product'),
                'post_status'       => array('publish'),
                'posts_per_page'    => 6,
        ...
        public static function products_noibat() {
        ...
        public static function product_ban_chay() {
            $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1; // trang dữ hiện tại cần lấy dữ liệu
            $posts_per_page = 6;
