...
if( !function_exists('woocustom_head') ) {
    function woocustom_head() {
    ?>
        <head>
            <meta charset="utf-8">
...
if( !function_exists('woocustom_header_body_open') ) {
    function woocustom_header_body_open() {
    ?>
        <body <?php body_class(); ?> >
		<div id="wallpaper">
			<header>
						...
						<div class="row">
							<div class="col-6 col-xs-6 col-sm-6 col-md-3 col-lg-3 order-md-0 order-0">
								<div class="logo">
									...
									><img src="<?php bloginfo("stylesheet_directory"); ?>/images/logo.png" alt=""></a>
...
if( !function_exists('woocustom_breadcrumbs') ) {
    function woocustom_breadcrumbs() {
    ?>
